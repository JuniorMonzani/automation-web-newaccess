class Constants
    ...
    #constante com os valores contidos no campo 'Fuso horário'
    ...
    #constante com os valores contidos no campo 'Controla sorteio' quando a área destino está habilitada
