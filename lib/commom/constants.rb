class Constants
    ...
    #constante com os valores contidos no dropbox 'Fuso horário'
    ...
    #constante com os valores contidos no dropbox 'Controla sorteio' quando a área destino está habilitada
    $CONTROL_SORTITION_HAS_DESTINATION_AREA = ['Nenhum', 'Área origem', 'Área destino', 'Ambos']

    #constante com os valores contidos no dropbox 'Controla sorteio' quando a área destino não está habilitada
    $CONTROL_SORTITION_NO_HAS_DESTINATION_AREA = ['Nenhum', 'Área origem']

    #constante com os valores contidos no dropbox 'Autenticação' no cadastro de tipo de credencial
    $CREDENTIAL_TYPE_AUTHENTICATION = ['Pessoa', 'Visitante', 'Credencial']

    #constante com os valores contidos no dropbox de filtro de pesquisa da tela Grupos de Equipamentos
