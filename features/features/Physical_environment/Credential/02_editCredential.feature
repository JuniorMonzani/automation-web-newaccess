...
Feature: edit Credential
    ...
    Scenario: verifySituationBlockedCredential
        Given Que eu busque e encontre a credencial de número "1002" cadastrada pela automação_005.
    ...
    Scenario: verifyReasonBlockedCredential
        Given Que eu busque e encontre a credencial de número "1002" cadastrada pela automação_006.
    ...
    Scenario: verifyCompany2Credential
        Given Que eu busque e encontre a credencial de número "1003" cadastrada pela automação_001.
    ...
    Scenario: verifyTechnologySmartCardCredential
        Given Que eu busque e encontre a credencial de número "1003" cadastrada pela automação_002.
    ...
    Scenario: verifyTypeCredentialCredential
        Given Que eu busque e encontre a credencial de número "1003" cadastrada pela automação_003.
    ...
    Scenario: verifyValidityFieldCredential
        Given Que eu busque e encontre a credencial de número "1003" cadastrada pela automação_004.
