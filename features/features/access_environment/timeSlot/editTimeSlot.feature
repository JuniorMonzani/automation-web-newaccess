...
Feature: edit Time Slot
    ...
    Scenario: verifyEditTimeSlot
        ...
        Then Deve direcionar para a página de alteração de Faixa Horária.
    ...
    Scenario: verifyFieldNumberOfTimeSlotDisabled
        ...
        Then Na tela de alteração de Faixa Horária eu verifico o campo Número e o mesmo deve estar desabilitado.
