...
Feature: Register Shift
    ...
    Scenario: verifyMessageSaveWithoutTimeSlot
        ...
        Given Preebcher o campo Hora virada com valor 1000.
        When Clicar no botão Salvar.
        Then Deveser apresentada uma mensagem ao usuário: '- Ao menos uma Faixa Horária deve ser selecionada'
    ...
    Scenario Outline: verifyMessageSaveSameNumberShift
        ...
        When Clicar no botão Salvar.
        Then O turno não deve ser salvo apresnetando as seguintes validações: "<mensagem_output>".
