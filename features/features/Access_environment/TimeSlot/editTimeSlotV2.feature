...
Feature: edit Time Slot
    ...
    Scenario: verifySearchAlfanumeric
        # Given Que o usuário esteja na página de faixa horária
        When Ao clicar checkbox 'As 10 últimas atualizações'
        And Faço a pesquisa inserindo letras
    ...
    Scenario: verifySearchNumeri
        # Given Que o usuário esteja na página de faixa horária
        When Ao clicar checkbox 'As 10 últimas atualizações'
        And Faço a pesquisa por um número não cadastrado
    ...
    Scenario: verifySearchNumber
        # Given Que o usuário esteja na página de faixa horária
        When Ao clicar checkbox 'As 10 últimas atualizações'
        And Faço a pesquisa pelo número '999999'
        Then Devo ver como resultado da pesquisa o cadastro do número: '999999'
    ...
    Scenario: verifyNumberTimeSlot
        ...
        And faça a busca
        When Eu clico no ícone de alteração da Faixa Horária.
        Then O número deve ser exatamente o número cadastrado para a Faixa Horária: '999999'.
    ...
    Scenario: verifyHoursTimeSlot
        ...
        And faça a busca
        When Eu clico no ícone de alteração da Faixa Horária.
        Then A Hora inicial e Hora final devem ser exatamente as mesmas cadastrado para a Faixa Horária: '10:10', '10:11'
