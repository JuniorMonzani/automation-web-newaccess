...
#   Given('Informar valor zero no campo {string} da tela Faixa Horária e preencher corretamente todas os outros campos necessários para efetuar o cadastro.') do |string|
#     fill_in 'MainContentMainMaster_MainContent_txtTimeSlotNumber', with: '0'
#     fill_in 'MainContentMainMaster_MainContent_txtInitialTimeSlot', with: '09:00'
#     fill_in 'MainContentMainMaster_MainContent_txtFinalTimeSlot', with: '10:00'
#   end
  
#   When('Clicar no botão Salvar para validar o campo {string} da tela Faixa Horária com o valor zero.') do |string|
#     click_button 'Salvar'
#   end
  
#   Then('Deve existir uma validação no campo {string} da tela Faixa Horária pois no mesmo é obrigatório um valor acima de zero.') do |string|
