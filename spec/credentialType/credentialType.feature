...
Feature: CredentialType
    ...
    @saveCredentialTypeWithPersonAuthentication
    ...
    @saveCredentialTypeWithVisitorAuthentication
    ...
    @saveCredentialTypeWithCredentialAuthentication
    ...
    @saveCredentialTypeAlreadyExists
    ...
    @verufyMessageDeleteCredentialType
