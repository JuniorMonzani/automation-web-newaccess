...
describe 'Realiza testes na página de Grupo de equipamento.', :equipmentGroup do
  ...
  context 'Valida os valores contidos nos dropbox:' do
    ...
    it 'Controla sorteio', :verifyValuesControlSortition do
    ...
    it '"Controla sorteio" após desmarcar a flag "Grupo tem área de destino"', :verifyValuesControlSortitionNoHasDestinationArea do
